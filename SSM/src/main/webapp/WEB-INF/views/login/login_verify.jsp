    ...
    <script>
        window.onload=function () {
            ...
            function reg_user() {
                ...
                var reg=/^{2,15}$/;
                if(!reg.test(str)){
                    document.getElementById("username_err").innerHTML="登录名/手机号/邮箱长度在2-15之间!"
                    return false;
                }
                return true;
            }
                ...
                <table>
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input id="username_id" class="form-control required text_input" type="text" placeholder="用户名/手机号/邮箱" name="username" autofocus="autofocus" maxlength="20"/>
                            </div>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="form-group">
                                ...
                                <input id="password_id" class="form-control required text_input" type="password" placeholder="密码" name="password" maxlength="20"/>
                            </div>
                        </td>
                        <td>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img src="/ssm/picture/get" class="picture">
                        </td>
                    </tr>
                </table>
                <div class="form-group">
